...
class __TwigTemplate_040602ebc7669cdfb9da26116daadadf72855abd5f9690ec0e527b909dcfd9c2 extends Template
{
  ...
  var mailpoet_account_url = '";
        // line 16
        echo $this->extensions['MailPoet\Twig\Functions']->addReferralId(((("https://account.mailpoet.com/?s=" . ($context["subscriber_count"] ?? null)) . "&email=") . \MailPoetVendor\twig_escape_filter($this->env, \MailPoetVendor\twig_get_attribute($this->env, $this->source, ($context["current_wp_user"] ?? null), "user_email", [], "any", false, false, false, 16), "js")));
        echo "';
  ...
  var mailpoet_current_wp_user_email = '";
        // line 21
        echo \MailPoetVendor\twig_escape_filter($this->env, \MailPoetVendor\twig_escape_filter($this->env, \MailPoetVendor\twig_get_attribute($this->env, $this->source, ($context["current_wp_user"] ?? null), "user_email", [], "any", false, false, false, 21), "js"), "html", null, true);
        echo "';
</script>
...
";
        // line 61
        $this->loadTemplate("mss_pitch_translations.html", "welcome_wizard.html", 61)->display($context);
        // line 62
        $this->loadTemplate("woocommerce_setup_translations.html", "welcome_wizard.html", 62)->display($context);
    }
    ...
    {
        return array (  140 => 62,  138 => 61,  135 => 60,  133 => 33,  129 => 32,  115 => 21,  111 => 20,  107 => 19,  103 => 18,  99 => 17,  95 => 16,  91 => 15,  86 => 13,  82 => 12,  78 => 11,  74 => 10,  70 => 9,  66 => 8,  62 => 7,  58 => 6,  54 => 5,  51 => 4,  47 => 3,  36 => 1,);
    }
